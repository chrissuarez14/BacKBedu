...
// function count(req,res,next){
// 	let categoria=req.params.cat; //pedir cual cateoria quiero buscar cat es de categoria `

// 	Mascotas.aggregate([ //repoduce la agregacion
// 		{
// 			'$match':{'categoria':categoria}}, //la varible contien lo que busco y ese juntara todo esta es primera eta[a]
// 			{'count':'total'}
// 	]) .then(r=>{
// 		res.status(200).send(r)
// 	})
